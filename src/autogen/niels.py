...
nls = {
    ...
    "operators": [
        ...
        ("arithmetic", "div", 2, {
            ...
            "array":    (
                "*res->value().{res_t} = bxx::bh_divide(*in1->value().{in1_t}, *in2->value().{in2_t})",
                binary_repeat_sigs(vtypes_grouped["array"][1:])
            ),
            "complex":  ("", []),
        }),
        ("arithmetic", "pow", 2, {
        ...
        ("comparison", "lthan", 2, {
            ...
            "array":    (
                ...
                [("bul_a", in1, in2) for out, in1, in2 in binary_repeat_sigs(vtypes_grouped["array"][1:3])]
            ),
            "complex":  ("", []),
        }),
